<h1>4342 - Create Grid With Exactly One Path</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/create-grid-with-exactly-one-path/">create-grid-with-exactly-one-path</a></h2><p>You are given two integers <code>m</code> and <code>n</code>, representing the number of rows and columns of a grid.</p>
