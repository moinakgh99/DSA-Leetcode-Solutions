<h1>1923 - Sentence Similarity III</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/sentence-similarity-iii/">sentence-similarity-iii</a></h2><p>You are given two strings <code>sentence1</code> and <code>sentence2</code>, each representing a <strong>sentence</strong> composed of words. A sentence is a list of <strong>words</strong> that are separated by a <strong>single</strong> space with no leading or trailing spaces. Each word consists of only uppercase and lowercase English characters.</p>
