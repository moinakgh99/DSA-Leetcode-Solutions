<h1>4332 - Check Good Integer</h1><h2>Difficulty: Easy - <a href="https://leetcode.com/problems/check-good-integer/">check-good-integer</a></h2><p>You are given a positive integer <code>n</code>.</p>
